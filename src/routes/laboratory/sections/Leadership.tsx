...
export const Leadership = ({ locale }: { locale?: Locale }): JSX.Element => {
          ...
          <div className="flex flex-col md:flex-row gap-8 lg:gap-12 md:items-start max-w-4xl px-4">
            <div className="flex-shrink-0 mx-auto md:mx-0">
              <div className="w-full aspect-square md:w-[240px] md:h-[260px] md:aspect-auto rounded-2xl overflow-hidden bg-gray-200">
                <img
                  src="/images/InstituteManagement/Melnychuk.webp"
                  alt={t.laboratory.leadership.name}
            ...
            <div className="flex flex-col gap-8 md:gap-10 pt-2">
              <div>
                <h3 className="font-bold text-xl md:text-2xl mb-2">
                  {t.laboratory.leadership.name}
                </h3>
                <p className="text-sm md:text-base text-black/80">
                  {t.laboratory.leadership.role}
                </p>
              </div>
              ...
              <div className="flex flex-col gap-6">
                <div>
                  <p className="text-sm text-black mb-1 font-semibold">
                    {t.laboratory.leadership.contactInfo}
                  </p>
                  <a
                    href="mailto:oleksandr.melnychuk@oa.edu.ua"
                ...
                <div>
                  <p className="text-sm text-black mb-1 font-semibold">
                    {t.laboratory.leadership.officeHours}
                  </p>
                  <p className="text-sm text-black">
                    {t.laboratory.leadership.officeHoursValue}
                  </p>
                </div>
              </div>
            </div>
