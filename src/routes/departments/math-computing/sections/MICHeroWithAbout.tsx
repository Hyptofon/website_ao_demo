...
export const MICHeroWithAbout = ({
  ...
  const heroWithAboutData: HeroWithAboutData = {
    heroTitle: t.departmentPages.mic.hero.title,
    heroDescription: t.departmentPages.mic.hero.description,
    cta: {
    ...
    aboutParagraphs: [...t.departmentPages.mic.hero.aboutParagraphs],
    aboutImage: {
      src: "/images/Departments/dmc-hero.webp",
