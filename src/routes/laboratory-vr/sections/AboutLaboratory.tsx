    ...
    return (
        <section className="w-full bg-pure-white text-pure-black pt-20 pb-10 2xl:pt-24 2xl:pb-12">
            <div className="container mx-auto px-4 md:px-9 flex flex-col">
                    ...
                    <div className="lg:col-span-5">
                        <ul className="list-disc pl-5 space-y-6 text-base md:text-lg leading-relaxed">
                            <li>
                                ...
                                <br /> Інтер’єри й екстер’єри будівель, міські простори та великі відкриті локації з інтерактивними елементами.
                            </li>
                            <li>
                                <strong>Історія та туризм</strong>
                                <br /> VR-експозиції, віртуальні музеї та інтерактивні шоуруми для культурних і туристичних проєктів.
                            </li>
                            <li>
                                <strong>Освітні рішення</strong>
                                <br /> Навчальні курси, симулятори та інтерактивні середовища для освіти й професійної підготовки.
                            </li>
                            <li>
                                <strong>Ігрові та VR-проєкти</strong>
                                <br /> Прості ігрові рішення та VR-додатки для демонстрацій, навчання або комерційного використання.
                            </li>
                        </ul>
                    </div>
                    <div className="hidden lg:block lg:col-span-3">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 border-b border-pure-black pb-16 md:pb-24 mb-16 md:mb-24">
                    <div className="lg:col-span-4">
                        <h3 className="text-2xl md:text-3xl font-bold">Напрямки досліджень</h3>
                    </div>
                    <div className="lg:col-span-5">
                        <ul className="list-disc pl-5 space-y-2 text-base md:text-lg leading-relaxed">
                            <li>Розробка імерсивних навчальних VR/AR-середовищ для освітніх програм.</li>
                            <li>Створення цифрових двійників для промислових об'єктів та інфраструктури.</li>
                            <li>Комп'ютерне моделювання та симуляція складних фізичних процесів.</li>
                            <li>Візуалізація великих масивів даних та наукових результатів.</li>
                            <li>Розробка інтерактивних 3D-моделей для музеїв, архітектури та культурної спадщини.</li>
                        </ul>
                    </div>
                    <div className="hidden lg:block lg:col-span-3">
                        <div className="aspect-[3/4] bg-gray-100 rounded-lg overflow-hidden flex items-center justify-center">
