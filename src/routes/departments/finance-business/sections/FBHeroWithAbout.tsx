...
export const FBHeroWithAbout = ({
  ...
  const heroWithAboutData: HeroWithAboutData = {
    heroTitle: t.departmentPages.fb.hero.title,
    heroDescription: t.departmentPages.fb.hero.description,
    cta: {
    ...
    aboutParagraphs: [...t.departmentPages.fb.hero.aboutParagraphs],
    aboutImage: {
      src: "/images/Departments/dfb-hero.webp",
