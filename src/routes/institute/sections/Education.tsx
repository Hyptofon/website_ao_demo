...
export const Education = ({ locale }: { locale?: Locale }): JSX.Element => {
  const t = getTranslations(locale);
  const educationData = t.institute.education.items;
    ...
    >
      <div className="max-w-7xl 2xl:max-w-screen-2xl mx-auto px-4 md:px-9">
        <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-16 lg:gap-24">
          {/* Title Section */}
          <div>
            <h2 className="font-bold text-4xl md:text-5xl lg:text-6xl leading-[1.1] text-white whitespace-pre-line">
              {t.institute.education.heading}
            </h2>
          </div>
